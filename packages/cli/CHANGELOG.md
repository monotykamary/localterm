...
- Updated dependencies [f92393f]
  - @monotykamary/localterm-server@2.79.10

## 2.79.9

### Patch Changes

- 02bfa1f: Make the OSC 8 links pi prints clickable. xterm's OSC 8 provider drops every link that isn't http(s) unless `linkHandler.allowNonHttpProtocols` is set, so pi's file:// tool-output paths and the scheme-less markdown hrefs a model writes painted the hyperlink dashed underline yet never reached a click handler. http(s) links now open in a new tab; file and cwd-relative links open the read-only /api/file preview.
  - @monotykamary/localterm-server@2.79.9

## 2.79.8

### Patch Changes

- 77a8bab: Fix macOS daemon crash loops from per-file watcher descriptor exhaustion. Restore native recursive watching on macOS and Windows, use native nonrecursive subscriptions, and keep Linux recursive watcher errors inside the recovery boundary.
- Updated dependencies [77a8bab]
  - @monotykamary/localterm-server@2.79.8

## 2.79.7

### Patch Changes

- Updated dependencies [4213de8]
  - @monotykamary/localterm-server@2.79.7
...
- Updated dependencies [773b9bc]
  - @monotykamary/localterm-server@2.79.2

## 2.79.1

### Patch Changes

- 52a01e2: Allow the macOS secret helper to inject up to 64 configured secrets, matching the process limit so `pi` and other shims do not exit before launch when more than 32 secrets are selected.
  - @monotykamary/localterm-server@2.79.1

## 2.79.0

### Patch Changes

- Updated dependencies [523642f]
  - @monotykamary/localterm-server@2.79.0
...
- Updated dependencies [30c1131]
  - @monotykamary/localterm-server@2.77.3
...
- Updated dependencies [213c848]
  - @monotykamary/localterm-server@2.77.1
...
- Updated dependencies [2cc1413]
  - @monotykamary/localterm-server@2.76.9

## 2.76.8

### Patch Changes

- 847f02b: Stop reopening last workspace tabs via CDP on daemon start. Browser tab restore and session IDs already bring the same tabs back; the Settings toggle and `workspaceRestore` config knob are gone.
  - @monotykamary/localterm-server@2.76.8
...
- f43c802: Bound Git diff subprocess fan-out by awaiting frontend prefetch work, coalescing concurrent cold cache builds, and discarding builds invalidated while in flight.
  - @monotykamary/localterm-server@2.76.6
...
- Updated dependencies [32aaf4e]
  - @monotykamary/localterm-server@2.76.3

## 2.76.2

### Patch Changes

- Updated dependencies [9dc9595]
  - @monotykamary/localterm-server@2.76.2
...
- Updated dependencies [7bcf8dc]
  - @monotykamary/localterm-server@2.76.0
...
- Updated dependencies [2de01d7]
  - @monotykamary/localterm-server@2.75.0
...
- Updated dependencies
  - @monotykamary/localterm-server@2.74.1
...
- Updated dependencies
  - @monotykamary/localterm-server@2.74.0
...
- Updated dependencies [70ccfc4]
  - @monotykamary/localterm-server@2.72.16

## 2.72.15

### Patch Changes

- Updated dependencies [1c7a91f]
  - @monotykamary/localterm-server@2.72.15

## 2.72.14

### Patch Changes

- Updated dependencies [51a376b]
  - @monotykamary/localterm-server@2.72.14

## 2.72.13

### Patch Changes

- Updated dependencies [ad5af9f]
  - @monotykamary/localterm-server@2.72.13
...
- Updated dependencies
  - @monotykamary/localterm-server@2.72.12

## 2.72.11

### Patch Changes

- Updated dependencies [1126fbb]
  - @monotykamary/localterm-server@2.72.11
...
- Updated dependencies [0a6a3c6]
  - @monotykamary/localterm-server@2.72.8
...
- Updated dependencies [e1be8a9]
  - @monotykamary/localterm-server@2.72.5
...
- c0d8ef2: Update development dependencies while retaining Geist Mono 5.2.7 to preserve terminal ligature rendering.
  - @monotykamary/localterm-server@2.72.3
...
- Updated dependencies
  - @monotykamary/localterm-server@2.70.5
...
- Updated dependencies [dbc65e2]
  - @monotykamary/localterm-server@2.70.0
...
- Updated dependencies [50e491b]
  - @monotykamary/localterm-server@2.69.0
...
- Updated dependencies [772bd33]
  - @monotykamary/localterm-server@2.67.0
...
- Updated dependencies [d97a014]
  - @monotykamary/localterm-server@2.66.23

## 2.66.22

### Patch Changes

- Updated dependencies [21deb44]
  - @monotykamary/localterm-server@2.66.22
...
- Updated dependencies [771af2d]
  - @monotykamary/localterm-server@2.66.20
...
- Updated dependencies [71739d8]
  - @monotykamary/localterm-server@2.66.17
...
- Updated dependencies [9242023]
  - @monotykamary/localterm-server@2.66.14
...
- Updated dependencies [a031b1e]
  - @monotykamary/localterm-server@2.66.12
...
- Updated dependencies [dbd8f95]
  - @monotykamary/localterm-server@2.66.11
