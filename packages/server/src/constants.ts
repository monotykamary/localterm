...
export const HIBERNATE_SCROLLBACK_MAX_CODE_UNITS = 256 * 1024;
...
export const KITTY_KEYBOARD_STACK_MAX_DEPTH = 16;
...
export const TERMINAL_ALTERNATE_SCREEN_PRIVATE_MODE_CODES: readonly number[] = [47, 1047, 1049];
...
export const WS_MAX_INBOUND_PAYLOAD_BYTES = 256 * 1024;
