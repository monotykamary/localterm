...
| 🎨 [**Themes & fonts**](docs/appearance.md)             | 20 built-in themes (16 dark + 4 light) + **Auto (system)**; import your own (JSON or iTerm `.itermcolors`); 11 bundled fonts + a custom system Nerd Font — all offline. |
