...
// alongside Sessions, Worktrees, and Automations. Keyboard shortcut:
// ⌘/Ctrl+Shift+D (see is-ports-shortcut.ts); also reachable via the command
// palette's "Dev ports" entry.
