const KITTY_UNICODE_DIACRITIC_CODE_POINTS = [
  ...
  0xaab7, 0xaab8, 0xaabe, 0xaabf, 0xaac1, 0xfe20, 0xfe21, 0xfe22, 0xfe23, 0xfe24, 0xfe25, 0xfe26,
  0x10a0f, 0x10a38, 0x1d185, 0x1d186, 0x1d187, 0x1d188, 0x1d189, 0x1d1aa, 0x1d1ab, 0x1d1ac, 0x1d1ad,
  0x1d242, 0x1d243, 0x1d244,
] as const;

const KITTY_UNICODE_DIACRITIC_INDICES = new Map<number, number>(
  KITTY_UNICODE_DIACRITIC_CODE_POINTS.map((codePoint, index) => [codePoint, index]),
);

export const kittyUnicodeDiacriticIndex = (codePoint: number): number | undefined =>
  KITTY_UNICODE_DIACRITIC_INDICES.get(codePoint);
