...
export const DIFF_VIEWER_ADDED_LINE_ANIMATION_MS = 250;
export const DIFF_VIEWER_REMOVED_LINE_ANIMATION_MS = 250;
export const DIFF_VIEWER_INITIAL_ANIMATION_DELAY_MS = 250;
export const DIFF_VIEWER_ANIMATION_SEQUENCE_GAP_MS = 250;
