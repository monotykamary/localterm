...
export const OSC_CLIPBOARD_IDENTIFIER = 52;
export const OSC_CLIPBOARD_READ_TIMEOUT_MS = 1_000;
...
export const PASTED_IMAGE_UPLOAD_TIMEOUT_MS = 60_000;
...
export const DIFF_VIEWER_BRANCH_SELECT_MIN_WIDTH_PX = 48;
...
export const KITTY_UNICODE_PLACEHOLDER_LAYER_CLASS = "xterm-kitty-unicode-placeholder-layer";
export const XTERM_BUFFER_CELL_CONTENT_INDEX = 0;
export const XTERM_BUFFER_CONTENT_CODE_POINT_MASK = 0x1fffff;
export const XTERM_BUFFER_CONTENT_IS_COMBINED_MASK = 0x200000;
export const XTERM_BUFFER_CELL_BACKGROUND_INDEX = 2;
export const XTERM_BUFFER_CELL_SIZE = 3;
export const XTERM_BUFFER_SPACE_CODE_POINT = 0x20;
export const XTERM_BUFFER_SINGLE_CELL_WIDTH = 1;
export const XTERM_BUFFER_CONTENT_WIDTH_SHIFT = 22;
export const XTERM_BUFFER_BACKGROUND_EXTENDED_MASK = 0x10000000;
export const XTERM_BUFFER_COLOR_MODE_MASK = 0x3000000;
export const XTERM_BUFFER_COLOR_MODE_PALETTE_16 = 0x1000000;
export const XTERM_BUFFER_COLOR_MODE_PALETTE_256 = 0x2000000;
export const XTERM_BUFFER_COLOR_MODE_RGB = 0x3000000;
export const XTERM_BUFFER_COLOR_PALETTE_MASK = 0xff;
export const XTERM_BUFFER_COLOR_RGB_MASK = 0xffffff;
export const XTERM_EXTENDED_UNDERLINE_STYLE_SHIFT = 26;
export const XTERM_EXTENDED_UNDERLINE_STYLE_MASK = 0x1c000000;
export const XTERM_EXTENDED_VARIANT_OFFSET_SHIFT = 29;
export const XTERM_EXTENDED_VARIANT_OFFSET_MASK = 0xe0000000;
export {
...
export const KEYBOARD_FLOATING_BUTTON_STORAGE_KEY = "localterm:keyboard-floating-button";
export const CTRL_N_TAKEOVER_STORAGE_KEY = "localterm:ctrl-n-takeover";
export const DEFAULT_CTRL_N_TAKEOVER_ENABLED = false;
export const CTRL_N_TAKEOVER_ERROR_FEEDBACK_MS = 3000;
export const CTRL_N_TAKEOVER_ERROR_TOAST_ID = "ctrl-n-takeover-error";
