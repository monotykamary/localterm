...
How automations fire, what shows up in run history, and the CDP/fallback browser-tab mechanics. For the endpoint surface, see [SKILL.md](../SKILL.md#automations).
